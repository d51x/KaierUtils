...
public enum EtacsVariantCoding {
    ...
    public static ArrayList<String> getAvailableOptions(int id) {
        Stream<String> stream = switch (id) {
            ...
            case 3 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            ...
            case 10 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            ...
            case 13 -> Arrays.stream(EtacsVariantData.EtacsVariantData_Disable_Enable.values()).map(EtacsVariantData.EtacsVariantData_Disable_Enable::getTitle);
            ...
            case 20 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 21 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 22 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 23 -> Arrays.stream(EtacsVariantData.EtacsVariantData23.values()).map(EtacsVariantData.EtacsVariantData23::getTitle);
            case 24 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 25 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 26 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 27 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 28 -> Arrays.stream(EtacsVariantData.EtacsVariantData28.values()).map(EtacsVariantData.EtacsVariantData28::getTitle);
            case 29 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 30 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 31 -> Arrays.stream(EtacsVariantData.EtacsVariantData31.values()).map(EtacsVariantData.EtacsVariantData31::getTitle);
            case 32 -> Arrays.stream(EtacsVariantData.EtacsVariantData_Disable_Enable.values()).map(EtacsVariantData.EtacsVariantData_Disable_Enable::getTitle);
            case 33 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            ...
            case 42 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 43 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 44 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 45 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 46 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 47 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 48 -> Arrays.stream(EtacsVariantData.EtacsVariantData48.values()).map(EtacsVariantData.EtacsVariantData48::getTitle);
            case 49 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 50 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 51 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 52 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 53 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 54 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 55 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 56 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            ...
            case 62 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 63 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 64 -> Arrays.stream(EtacsVariantData.EtacsVariantData64.values()).map(EtacsVariantData.EtacsVariantData64::getTitle);
            case 65 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 66 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 67 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 68 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 69 -> Arrays.stream(EtacsVariantData.EtacsVariantData69.values()).map(EtacsVariantData.EtacsVariantData69::getTitle);
            case 70 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 71 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 72 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            ...
            case 75 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 76 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 77 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 78 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 79 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 80 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 81 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 82 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            ...
            case 85 -> Arrays.stream(EtacsVariantData.EtacsVariantData_Disable_Enable.values()).map(EtacsVariantData.EtacsVariantData_Disable_Enable::getTitle);
            case 86 -> Arrays.stream(EtacsVariantData.EtacsVariantData_Disable_Enable.values()).map(EtacsVariantData.EtacsVariantData_Disable_Enable::getTitle);
            case 87 -> Arrays.stream(EtacsVariantData.EtacsVariantData87.values()).map(EtacsVariantData.EtacsVariantData87::getTitle);
            case 88 -> Arrays.stream(EtacsVariantData.EtacsVariantData_Enable_Disable.values()).map(EtacsVariantData.EtacsVariantData_Enable_Disable::getTitle);
            ...
            case 91 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            ...
            case 97 -> Arrays.stream(EtacsVariantData.EtacsVariantData_Disable_Enable.values()).map(EtacsVariantData.EtacsVariantData_Disable_Enable::getTitle);
            ...
            case 102 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            ...
            case 106 -> Arrays.stream(EtacsVariantData.EtacsVariantData_Present_NotPresent.values()).map(EtacsVariantData.EtacsVariantData_Present_NotPresent::getTitle);
            case 107 -> Arrays.stream(EtacsVariantData.EtacsVariantData_Disable_Enable.values()).map(EtacsVariantData.EtacsVariantData_Disable_Enable::getTitle);
            ...
            case 111 -> Arrays.stream(EtacsVariantData.EtacsVariantData_Disable_Enable.values()).map(EtacsVariantData.EtacsVariantData_Disable_Enable::getTitle);
            case 112 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            ...
            case 115 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 116 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            ...
            case 120 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            ...
            case 123 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 124 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 125 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 126 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getTitle);
            ...
            case 133 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getTitle);
            case 134 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getTitle);
            case 135 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getTitle);
            case 136 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getTitle);
            case 137 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getTitle);
            case 138 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getTitle);
            case 139 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getTitle);
            case 140 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getTitle);
            case 141 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getTitle);
            case 142 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getTitle);
            case 143 -> Arrays.stream(EtacsVariantData.EtacsVariantData143.values()).map(EtacsVariantData.EtacsVariantData143::getTitle);
            case 144 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getTitle);
            case 145 -> Arrays.stream(EtacsVariantData.EtacsVariantData145.values()).map(EtacsVariantData.EtacsVariantData145::getTitle);
            case 146 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getTitle);
            case 147 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getTitle);
            case 148 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getTitle);
            case 149 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getTitle);
            case 150 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getTitle);
            case 151 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getTitle);
            ...
            case 154 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            ...
            case 157 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 158 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 159 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 160 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 161 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 162 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 163 -> Arrays.stream(EtacsVariantData.EtacsVariantData163.values()).map(EtacsVariantData.EtacsVariantData163::getTitle);
            case 164 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 165 -> Arrays.stream(EtacsVariantData.EtacsVariantData165.values()).map(EtacsVariantData.EtacsVariantData165::getTitle);
            case 166 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 167 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getTitle);
            case 168 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 169 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 170 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 171 -> Arrays.stream(EtacsVariantData.EtacsVariantData_Disable_Enable.values()).map(EtacsVariantData.EtacsVariantData_Disable_Enable::getTitle);
            ...
            case 174 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            ...
            case 178 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 179 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 180 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getTitle);
            case 205 -> Arrays.stream(EtacsVariantData.EtacsVariantData_Disable_Enable.values()).map(EtacsVariantData.EtacsVariantData_Disable_Enable::getTitle);
    ...
    public static ArrayList<Integer> getAvailableValues(int id) {
        Stream<Integer> stream = switch (id) {
            ...
            case 3 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            ...
            case 10 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            ...
            case 13 -> Arrays.stream(EtacsVariantData.EtacsVariantData_Disable_Enable.values()).map(EtacsVariantData.EtacsVariantData_Disable_Enable::getIdx);
            ...
            case 20 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 21 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 22 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 23 -> Arrays.stream(EtacsVariantData.EtacsVariantData23.values()).map(EtacsVariantData.EtacsVariantData23::getIdx);
            case 24 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 25 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 26 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 27 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 28 -> Arrays.stream(EtacsVariantData.EtacsVariantData28.values()).map(EtacsVariantData.EtacsVariantData28::getIdx);
            case 29 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 30 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 31 -> Arrays.stream(EtacsVariantData.EtacsVariantData31.values()).map(EtacsVariantData.EtacsVariantData31::getIdx);
            case 32 -> Arrays.stream(EtacsVariantData.EtacsVariantData_Disable_Enable.values()).map(EtacsVariantData.EtacsVariantData_Disable_Enable::getIdx);
            case 33 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            ...
            case 42 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 43 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 44 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 45 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 46 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 47 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 48 -> Arrays.stream(EtacsVariantData.EtacsVariantData48.values()).map(EtacsVariantData.EtacsVariantData48::getIdx);
            case 49 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 50 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 51 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 52 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 53 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 54 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 55 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 56 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            ...
            case 62 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 63 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 64 -> Arrays.stream(EtacsVariantData.EtacsVariantData64.values()).map(EtacsVariantData.EtacsVariantData64::getIdx);
            case 65 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 66 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 67 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 68 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 69 -> Arrays.stream(EtacsVariantData.EtacsVariantData69.values()).map(EtacsVariantData.EtacsVariantData69::getIdx);
            case 70 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 71 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 72 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            ...
            case 75 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 76 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 77 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 78 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 79 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 80 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 81 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 82 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            ...
            case 85 -> Arrays.stream(EtacsVariantData.EtacsVariantData_Disable_Enable.values()).map(EtacsVariantData.EtacsVariantData_Disable_Enable::getIdx);
            case 86 -> Arrays.stream(EtacsVariantData.EtacsVariantData_Disable_Enable.values()).map(EtacsVariantData.EtacsVariantData_Disable_Enable::getIdx);
            case 87 -> Arrays.stream(EtacsVariantData.EtacsVariantData87.values()).map(EtacsVariantData.EtacsVariantData87::getIdx);
            case 88 -> Arrays.stream(EtacsVariantData.EtacsVariantData_Enable_Disable.values()).map(EtacsVariantData.EtacsVariantData_Enable_Disable::getIdx);
            ...
            case 91 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            ...
            case 97 -> Arrays.stream(EtacsVariantData.EtacsVariantData_Disable_Enable.values()).map(EtacsVariantData.EtacsVariantData_Disable_Enable::getIdx);
            ...
            case 102 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            ...
            case 106 -> Arrays.stream(EtacsVariantData.EtacsVariantData_Present_NotPresent.values()).map(EtacsVariantData.EtacsVariantData_Present_NotPresent::getIdx);
            case 107 -> Arrays.stream(EtacsVariantData.EtacsVariantData_Disable_Enable.values()).map(EtacsVariantData.EtacsVariantData_Disable_Enable::getIdx);
            ...
            case 111 -> Arrays.stream(EtacsVariantData.EtacsVariantData_Disable_Enable.values()).map(EtacsVariantData.EtacsVariantData_Disable_Enable::getIdx);
            case 112 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            ...
            case 115 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 116 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            ...
            case 120 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            ...
            case 123 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 124 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 125 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 126 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getIdx);
            ...
            case 133 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getIdx);
            case 134 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getIdx);
            case 135 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getIdx);
            case 136 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getIdx);
            case 137 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getIdx);
            case 138 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getIdx);
            case 139 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getIdx);
            case 140 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getIdx);
            case 141 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getIdx);
            case 142 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getIdx);
            case 143 -> Arrays.stream(EtacsVariantData.EtacsVariantData143.values()).map(EtacsVariantData.EtacsVariantData143::getIdx);
            case 144 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getIdx);
            case 145 -> Arrays.stream(EtacsVariantData.EtacsVariantData145.values()).map(EtacsVariantData.EtacsVariantData145::getIdx);
            case 146 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getIdx);
            case 147 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getIdx);
            case 148 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getIdx);
            case 149 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getIdx);
            case 150 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getIdx);
            case 151 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getIdx);
            ...
            case 154 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            ...
            case 157 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 158 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 159 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 160 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 161 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 162 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 163 -> Arrays.stream(EtacsVariantData.EtacsVariantData163.values()).map(EtacsVariantData.EtacsVariantData163::getIdx);
            case 164 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 165 -> Arrays.stream(EtacsVariantData.EtacsVariantData165.values()).map(EtacsVariantData.EtacsVariantData165::getIdx);
            case 166 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 167 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotAvailable_Available.values()).map(EtacsVariantData.EtacsVariantData_NotAvailable_Available::getIdx);
            case 168 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 169 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 170 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 171 -> Arrays.stream(EtacsVariantData.EtacsVariantData_Disable_Enable.values()).map(EtacsVariantData.EtacsVariantData_Disable_Enable::getIdx);
            ...
            case 174 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            ...
            case 178 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 179 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 180 -> Arrays.stream(EtacsVariantData.EtacsVariantData_NotPresent_Present.values()).map(EtacsVariantData.EtacsVariantData_NotPresent_Present::getIdx);
            case 205 -> Arrays.stream(EtacsVariantData.EtacsVariantData_Disable_Enable.values()).map(EtacsVariantData.EtacsVariantData_Disable_Enable::getIdx);
            default -> Stream.of(-1);
        };
