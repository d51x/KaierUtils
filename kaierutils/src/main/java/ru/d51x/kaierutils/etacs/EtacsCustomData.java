...
public class EtacsCustomData {
    public enum EtacsCustomData1 {
        ...
        EtacsCustomData1(int idx, String title) { this.idx = idx; this.title = title; }
    ...
    public enum EtacsCustomData2 {
        ...
        private final int idx;
        private final String title;
        EtacsCustomData2(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    public enum EtacsCustomData3 {
        ...
        private final int idx;
        private final String title;
        EtacsCustomData3(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    public enum EtacsCustomData4 {
        ...
        private final int idx;
        private final String title;
        EtacsCustomData4(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData5 {
        ...
        EtacsCustomData5(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData6 {
        ...
        EtacsCustomData6(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData7 {
        ...
        EtacsCustomData7(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData8 {
        ...
        EtacsCustomData8(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData9 {
        ...
        EtacsCustomData9(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData10 {
        ...
        EtacsCustomData10(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData11 {
        ...
        EtacsCustomData11(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData12 {
        ...
        EtacsCustomData12(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData13 {
        ...
        EtacsCustomData13(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData14 {
        ...
        EtacsCustomData14(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData15 {
        ...
        EtacsCustomData15(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData16 {
        ...
        EtacsCustomData16(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData17 {
        ...
        EtacsCustomData17(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData18 {
        ...
        EtacsCustomData18(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData19 {
        ...
        EtacsCustomData19(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData20 {
        ...
        EtacsCustomData20(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData21 {
        ...
        EtacsCustomData21(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData22 {
        ...
        EtacsCustomData22(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData23 {
        ...
        EtacsCustomData23(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData24 {
        ...
        EtacsCustomData24(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData25 {
        ...
        EtacsCustomData25(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData26 {
        ...
        EtacsCustomData26(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData27 {
        ...
        EtacsCustomData27(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData28 {
        ...
        EtacsCustomData28(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData29 {
        ...
        EtacsCustomData29(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData30 {
        ...
        EtacsCustomData30(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData31 {
        ...
        EtacsCustomData31(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData32 {
        ...
        EtacsCustomData32(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData33 {
        ...
        EtacsCustomData33(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData34 {
        ...
        EtacsCustomData34(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData35 {
        ...
        EtacsCustomData35(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData36 {
        ...
        EtacsCustomData36(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData37 {
        ...
        EtacsCustomData37(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData38 {
        ...
        EtacsCustomData38(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData39 {
        ...
        EtacsCustomData39(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData40 {
        ...
        EtacsCustomData40(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData41 {
        ...
        EtacsCustomData41(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData42 {
        ...
        EtacsCustomData42(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData43 {
        ...
        EtacsCustomData43(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData44 {
        ...
        EtacsCustomData44(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
    ...
    public enum EtacsCustomData45 {
        ...
        EtacsCustomData45(int idx, String title) { this.idx = idx; this.title = title; }
        public int getIdx() { return idx; }
        public String getTitle() { return title; }
    }
}
